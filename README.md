[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/AaEQG5XG)
# Assignment 2
**Due by 11:59pm on Sunday, 2/4/2024** <br/>
...
* 20 points: Submission contains complete unit tests for `verifyEmail()`.
...
* 25 points: Submission contains complete unit tests for `verifyPassword()`.
  * 5 points: Unit tests are correctly set up using Jest and execute to completion.
...
* 35 points: Submission successfully uses TDD to implement "old" Roman numeral converter.
...
* 20 points: Awarded during assignment demo by aswering questioned presented by TA.
